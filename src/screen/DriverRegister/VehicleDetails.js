            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
                <View style={styles.container}>
                    ...
                    <View style={styles.contentContainer}>
                        ...
                        <View>
                            ...
                            <View style={[styles.inputContainer, styles.pickerContainer]}>
                                ...
                                >
                                    <Picker.Item label="Vehicle Owner" value="" color="#A9A9A9" enabled={false} />
                            ...
                            <View style={[styles.inputContainer, styles.pickerContainer]}>
                                ...
                                <Picker
                                    ...
                                    onValueChange={(itemValue) => setVehicleOwner(itemValue)}
                                >
                                    <Picker.Item label="Fuel Type" value="" color="#A9A9A9" enabled={false} />
                        ...
                        <View style={styles.imageContainer}>
                            ...
                            <Text style={styles.subLabel}>Upload RC</Text>
                        ...
                        <View style={styles.imageContainer}>
                            ...
                            <Text style={styles.subLabel}>Upload Permit</Text>
                            <View style={styles.rowContainer}>
                                <TouchableOpacity
                                    style={[
                                        styles.imageBox,
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => navigation.navigate('PanAadhar')}>
